...
type WorkflowExecutionInfo struct {
	...
	WorkspaceInfos map[string]*v18.WorkspaceInfo `protobuf:"bytes,115,rep,name=workspace_infos,json=workspaceInfos,proto3" json:"workspace_infos,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_temporal_server_api_persistence_v1_executions_proto_rawDesc = "" +
	"\n" +
	"3temporal/server/api/persistence/v1/executions.proto\x12\"temporal.server.api.persistence.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$temporal/api/common/v1/message.proto\x1a\"temporal/api/enums/v1/common.proto\x1a&temporal/api/enums/v1/event_type.proto\x1a(temporal/api/enums/v1/failed_cause.proto\x1a$temporal/api/enums/v1/workflow.proto\x1a%temporal/api/enums/v1/workspace.proto\x1a%temporal/api/failure/v1/message.proto\x1a&temporal/api/workflow/v1/message.proto\x1a%temporal/api/history/v1/message.proto\x1a(temporal/api/deployment/v1/message.proto\x1a*temporal/server/api/clock/v1/message.proto\x1a)temporal/server/api/enums/v1/common.proto\x1a(temporal/server/api/enums/v1/nexus.proto\x1a+temporal/server/api/enums/v1/workflow.proto\x1a'temporal/server/api/enums/v1/task.proto\x1a5temporal/server/api/enums/v1/workflow_task_type.proto\x1a,temporal/server/api/history/v1/message.proto\x1a.temporal/server/api/persistence/v1/chasm.proto\x1a/temporal/server/api/persistence/v1/queues.proto\x1a,temporal/server/api/persistence/v1/hsm.proto\x1a/temporal/server/api/persistence/v1/update.proto\x1a'temporal/api/workspace/v1/message.proto\x1a-temporal/server/api/workflow/v1/message.proto\"\xa3\x05\n" +
	"\tShardInfo\x12\x19\n" +
	...
	"J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\f\x10\rJ\x04\b\x0e\x10\x0fJ\x04\b\x0f\x10\x10J\x04\b\x10\x10\x11\"\xc0D\n" +
	...
	"\x1fdeclined_target_version_upgrade\x18r \x01(\v25.temporal.api.history.v1.DeclinedTargetVersionUpgradeR\x1cdeclinedTargetVersionUpgrade\x12v\n" +
	"\x0fworkspace_infos\x18s \x03(\v2M.temporal.server.api.persistence.v1.WorkflowExecutionInfo.WorkspaceInfosEntryR\x0eworkspaceInfos\x1ad\n" +
	...
	"\x05value\x18\x02 \x01(\v22.temporal.server.api.persistence.v1.ResetChildInfoR\x05value:\x028\x01\x1ak\n" +
	"\x13WorkspaceInfosEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.temporal.api.workspace.v1.WorkspaceInfoR\x05value:\x028\x01B\x1c\n" +
	...
	"\aattempt\x18\x01 \x01(\x05R\aattempt\"\xa1\x1c\n" +
	...
	"\fworkspace_id\x183 \x01(\tR\vworkspaceId\x12^\n" +
	"\x15workspace_access_mode\x184 \x01(\x0e2*.temporal.api.enums.v1.WorkspaceAccessModeR\x13workspaceAccessMode\x1ay\n" +
...
var file_temporal_server_api_persistence_v1_executions_proto_goTypes = []any{
	...
	(*v18.WorkspaceInfo)(nil),                          // 88: temporal.api.workspace.v1.WorkspaceInfo
	(*StateMachineRef)(nil),                            // 89: temporal.server.api.persistence.v1.StateMachineRef
}
var file_temporal_server_api_persistence_v1_executions_proto_depIdxs = []int32{
	...
	20,  // 116: temporal.server.api.persistence.v1.CallbackInfo.callback:type_name -> temporal.server.api.persistence.v1.Callback
	...
	72,  // 121: temporal.server.api.persistence.v1.CallbackInfo.last_attempt_failure:type_name -> temporal.api.failure.v1.Failure
	...
	72,  // 127: temporal.server.api.persistence.v1.NexusOperationInfo.last_attempt_failure:type_name -> temporal.api.failure.v1.Failure
	...
	72,  // 135: temporal.server.api.persistence.v1.NexusOperationCancellationInfo.last_attempt_failure:type_name -> temporal.api.failure.v1.Failure
	...
	25,  // 143: temporal.server.api.persistence.v1.WorkflowExecutionInfo.ChildrenInitializedPostResetPointEntry.value:type_name -> temporal.server.api.persistence.v1.ResetChildInfo
	88,  // 144: temporal.server.api.persistence.v1.WorkflowExecutionInfo.WorkspaceInfosEntry.value:type_name -> temporal.api.workspace.v1.WorkspaceInfo
	5,   // 145: temporal.server.api.persistence.v1.WorkflowExecutionState.RequestIdsEntry.value:type_name -> temporal.server.api.persistence.v1.RequestIDInfo
	45,  // 146: temporal.server.api.persistence.v1.ActivityInfo.PauseInfo.pause_time:type_name -> google.protobuf.Timestamp
	39,  // 147: temporal.server.api.persistence.v1.ActivityInfo.PauseInfo.manual:type_name -> temporal.server.api.persistence.v1.ActivityInfo.PauseInfo.Manual
	42,  // 148: temporal.server.api.persistence.v1.Callback.Nexus.header:type_name -> temporal.server.api.persistence.v1.Callback.Nexus.HeaderEntry
	89,  // 149: temporal.server.api.persistence.v1.Callback.HSM.ref:type_name -> temporal.server.api.persistence.v1.StateMachineRef
	43,  // 150: temporal.server.api.persistence.v1.CallbackInfo.Trigger.workflow_closed:type_name -> temporal.server.api.persistence.v1.CallbackInfo.WorkflowClosed
