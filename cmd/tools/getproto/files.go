...
import (
	...
	workspace "go.temporal.io/api/workspace/v1"
...
func init() {
	...
	importMap["temporal/api/enums/v1/workspace.proto"] = enums.File_temporal_api_enums_v1_workspace_proto
	...
	importMap["temporal/api/workspace/v1/message.proto"] = workspace.File_temporal_api_workspace_v1_message_proto
}
